...
define('_AM_SYSTEM_USERS_URL', 'ウェブ URL');
...
define('_AM_SYSTEM_USERS_PWDEQUALSUNAME', 'パスワードをユーザー名と同じにすることはできません。');
...
//2.7.0
define('_AM_SYSTEM_USERS_UNKNOWN_GROUP', '不明なグループ');

//2.7.4
define('_AM_SYSTEM_USERS_NO_SUCH_USER', 'そのようなユーザーは存在しません');
