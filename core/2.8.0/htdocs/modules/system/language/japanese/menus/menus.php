...
define('MENUS_HOME', 'ホーム');
define('MENUS_ADMIN', '管理');
define('MENUS_ACCOUNT', 'アカウント');
define('MENUS_ACCOUNT_EDIT', 'アカウントを編集');
define('MENUS_ACCOUNT_LOGIN', 'ログイン');
define('MENUS_ACCOUNT_LOGOUT', 'ログアウト');
define('MENUS_ACCOUNT_REGISTER', '新規登録');
define('MENUS_ACCOUNT_MESSAGES', 'メッセージ');
define('MENUS_ACCOUNT_NOTIFICATIONS', '通知');
define('MENUS_ACCOUNT_TOOLBAR', 'ツールバー');
