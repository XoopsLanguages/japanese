...
//2.5.9
define("CURL_HTTP", "クライアント URL ライブラリ (cURL)");
...
define('_WEBSITE_NAME', 'XOOPS サイト');
define('_WEBSITE_SLOGAN', 'そのまま使ってください！');
define('_WEBSITE_META_KEYWORDS', 'xoops、Web アプリケーション フレームワーク、CMS、コンテンツ管理システム');
define('_WEBSITE_FOOTER', "Powered by XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>XOOPS プロジェクト</a>");
define('_WEBSITE_COPYRIGHT', '著作権 © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS は、PHP で記述された動的なオブジェクト指向ベースのオープン ソース ポータル スクリプトです。');
define('_WEBSITE_CENSOR_REPLACE', 'おっと');
